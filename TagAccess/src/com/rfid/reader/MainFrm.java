...
public class MainFrm extends JFrame {
	...
	private long m_hr = 0;//读卡器操作句柄
	private long m_ht = 0;//标签操作句柄
	...
	public MainFrm(){ 
		...
		panel14443A.setBorder(new TitledBorder(null, "Mifare S50", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		setResizable(false);
		...
		panelInventory.setBorder(new TitledBorder(null, "Inventory", TitledBorder.LEADING, TitledBorder.TOP, null, null));

		JPanel panelIcodeSli = new JPanel();
		panelIcodeSli.setBorder(new TitledBorder(null, "ICODE SLI", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		
		JPanel panelUltralight = new JPanel();
		panelUltralight.setBorder(new TitledBorder(null, "Mifare Ultralight", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		btnConnect_Ultralight.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				String sUid = cmbUid_Ultralight.getItemAt(cmbUid_Ultralight.getSelectedIndex());
				if (sUid==null) {
					return;
				}

				if (b_inventoryFlg) {
					JOptionPane.showMessageDialog(null, "Please stop inventory first!");
					return;
				}

				byte[] uid = gFunction.decodeHex(sUid);
				if (uid.length!=7) {
					JOptionPane.showMessageDialog(null, "The UID is not right!");
					return;
				}
				//ULTRALIGHT_Connect(long hr,byte[]uid/* 7 bytes */,Long ht)
				Long ht = new Long(0);
				int nret = rfidlib_aip_iso14443A.ULTRALIGHT_Connect(m_hr,uid, ht);
				if (nret!=0) {
		...
		btnWriteBlk_Utralight.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int nret = rfidlib_aip_iso14443A.ULTRALIGHT_WriteMultiplePages(m_hr,m_ht,(byte)blkAddr,(byte)blkNum,newBlkData,newBlkData.length);
				if (nret==0) {
				...
				//JOptionPane.showMessageDialog(null, "The address must be between 4 and 43.");
			}
		});
		...
		btnReadBlk_Utralight.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int nret = rfidlib_aip_iso14443A.ULTRALIGHT_ReadMultiplePages(m_hr,m_ht,(byte)blkAddr,(byte)numOfBlksToRead,bufBlocks,nSize);
				if (nret!=0) {
					JOptionPane.showMessageDialog(null, "Read multi block failed!err="+nret);
					return;
				}
		...
		gl_panelUltralight.setHorizontalGroup(
			gl_panelUltralight.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelUltralight.createSequentialGroup()
					.addContainerGap()
					.addGroup(gl_panelUltralight.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panelUltralight.createSequentialGroup()
							.addComponent(label)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(cmbUid_Ultralight, GroupLayout.PREFERRED_SIZE, 105, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.UNRELATED)
							.addComponent(btnConnect_Ultralight)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(btnDisconnect_Ultralight))
						.addGroup(gl_panelUltralight.createSequentialGroup()
							.addComponent(lblAddress)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(comboBoxAddr_Ultralight, GroupLayout.PREFERRED_SIZE, 66, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(label_1, GroupLayout.PREFERRED_SIZE, 60, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(comboBoxNum_Utralight, GroupLayout.PREFERRED_SIZE, 50, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(label_4)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(textField_Utralight, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.UNRELATED)
							.addComponent(btnWriteBlk_Utralight)
							.addGap(10)
							.addComponent(btnReadBlk_Utralight)))
					.addContainerGap(561, Short.MAX_VALUE))
		);
		gl_panelUltralight.setVerticalGroup(
			gl_panelUltralight.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelUltralight.createSequentialGroup()
					.addContainerGap()
					.addGroup(gl_panelUltralight.createParallelGroup(Alignment.BASELINE)
						.addComponent(label)
						.addComponent(cmbUid_Ultralight, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addComponent(btnConnect_Ultralight)
						.addComponent(btnDisconnect_Ultralight))
					.addPreferredGap(ComponentPlacement.RELATED)
					.addGroup(gl_panelUltralight.createParallelGroup(Alignment.BASELINE)
						.addComponent(label_4)
						.addComponent(lblAddress)
						.addComponent(comboBoxAddr_Ultralight, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addComponent(textField_Utralight, GroupLayout.PREFERRED_SIZE, 21, GroupLayout.PREFERRED_SIZE)
						.addComponent(btnWriteBlk_Utralight)
						.addComponent(btnReadBlk_Utralight)
						.addComponent(label_1)
						.addComponent(comboBoxNum_Utralight, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(panelUltralight, GroupLayout.DEFAULT_SIZE, 1047, Short.MAX_VALUE)
							.addContainerGap())
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(panelIcodeSli, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
							.addContainerGap())
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(panelInventory, GroupLayout.PREFERRED_SIZE, 840, GroupLayout.PREFERRED_SIZE)
							.addContainerGap())
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(panel, GroupLayout.PREFERRED_SIZE, 852, GroupLayout.PREFERRED_SIZE)
							.addContainerGap(218, Short.MAX_VALUE))
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(panel14443A, GroupLayout.PREFERRED_SIZE, 1047, Short.MAX_VALUE)
							.addGap(23))))
		);
		groupLayout.setVerticalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGap(18)
					.addComponent(panelInventory, GroupLayout.PREFERRED_SIZE, 146, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(panelIcodeSli, GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE)
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addComponent(panel14443A, GroupLayout.DEFAULT_SIZE, 126, Short.MAX_VALUE)
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addComponent(panelUltralight, GroupLayout.PREFERRED_SIZE, 109, GroupLayout.PREFERRED_SIZE)
					.addGap(103))
		);
		GroupLayout gl_panel14443A = new GroupLayout(panel14443A);
		gl_panel14443A.setHorizontalGroup(
			gl_panel14443A.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel14443A.createSequentialGroup()
					.addContainerGap()
					.addGroup(gl_panel14443A.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel14443A.createSequentialGroup()
							.addComponent(lblUid_iso14443a)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(cmbUid_S50, GroupLayout.PREFERRED_SIZE, 105, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.UNRELATED)
							.addComponent(btnConnect_S50)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(btnDisconnect_S50)
							.addPreferredGap(ComponentPlacement.UNRELATED)
							.addComponent(lblBlkaddr_S50)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(cmbBlkaddr_S50, GroupLayout.PREFERRED_SIZE, 66, GroupLayout.PREFERRED_SIZE)
							.addGap(18)
							.addComponent(lblKeyType)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(cmbKeyType_S50, GroupLayout.PREFERRED_SIZE, 70, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.UNRELATED)
							.addComponent(lblKey)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(textKey_S50, GroupLayout.PREFERRED_SIZE, 79, GroupLayout.PREFERRED_SIZE)
							.addGap(6)
							.addComponent(btnAuthenticate_S50))
						.addGroup(gl_panel14443A.createSequentialGroup()
							.addComponent(lblBlkData_S50)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(textBlkData_S50, GroupLayout.PREFERRED_SIZE, 212, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(btnWriteBlk_S50)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(btnReadBlk_S50))
						.addGroup(gl_panel14443A.createSequentialGroup()
							.addComponent(lblVal_S50)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(textValue_S50, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(btnFormateValBlk_S50)
							.addPreferredGap(ComponentPlacement.UNRELATED)
							.addComponent(btnIncrement_S50)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(btnDecrement_S50)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(btnRestore_S50)))
					.addContainerGap(40, Short.MAX_VALUE))
		);

		gl_panel14443A.setVerticalGroup(
			gl_panel14443A.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel14443A.createSequentialGroup()
					.addContainerGap()
					.addGroup(gl_panel14443A.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblUid_iso14443a)
						.addComponent(cmbUid_S50, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addComponent(btnConnect_S50)
						.addComponent(btnDisconnect_S50)
						.addComponent(lblBlkaddr_S50)
						.addComponent(cmbBlkaddr_S50, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addComponent(lblKeyType)
						.addComponent(cmbKeyType_S50, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addComponent(lblKey)
						.addComponent(textKey_S50, GroupLayout.PREFERRED_SIZE, 21, GroupLayout.PREFERRED_SIZE)
						.addComponent(btnAuthenticate_S50))
					.addPreferredGap(ComponentPlacement.RELATED)
					.addGroup(gl_panel14443A.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblBlkData_S50)
						.addComponent(textBlkData_S50, GroupLayout.PREFERRED_SIZE, 21, GroupLayout.PREFERRED_SIZE)
						.addComponent(btnWriteBlk_S50)
						.addComponent(btnReadBlk_S50))
					.addPreferredGap(ComponentPlacement.RELATED)
					.addGroup(gl_panel14443A.createParallelGroup(Alignment.BASELINE)
		...
		btnFormateValBlk_S50.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				int nret = rfidlib_aip_iso14443A.MFCL_FormatValueBlock(m_hr, m_ht, blkAddr, initValue);
				if (nret==0) {
		...
		btnIncrement_S50.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				int nret = rfidlib_aip_iso14443A.MFCL_Increment(m_hr, m_ht, blkAddr, val);
				if (nret==0) {
					JOptionPane.showMessageDialog(null, "OK!");
				}
				else {
		...
		btnDecrement_S50.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				byte blkAddr = (byte) cmbBlkaddr_S50.getSelectedIndex();
				int val = Integer.parseInt(textValue_S50.getText());
				int nret = rfidlib_aip_iso14443A.MFCL_Decrement(m_hr, m_ht, blkAddr, val);
				if (nret==0) {
					JOptionPane.showMessageDialog(null, "OK");
				} 
				else {
		...
		btnRestore_S50.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				byte blkAddr = (byte) cmbBlkaddr_S50.getSelectedIndex();
				int nret = rfidlib_aip_iso14443A.MFCL_Restore(m_hr, m_ht, blkAddr);
				if (nret==0) {
					JOptionPane.showMessageDialog(null, "Restore block successfully!");
				}else {
					JOptionPane.showMessageDialog(null, "Failure to restore block!err="+nret);
				}
			}
		});
		btnConnect_S50.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				String sUid = cmbUid_S50.getItemAt(cmbBlkaddr_S50.getSelectedIndex());
				if (sUid==null) {
					return;
				}
		...
		btnAuthenticate_S50.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (nret==0) {
					...
					JOptionPane.showMessageDialog(null, "Authenticate failed!err="+nret);
				}
			}
		});
		btnReadBlk_S50.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (nret!=0) {
					JOptionPane.showMessageDialog(null, "Read block failed!err="+nret);
					return;
				}
		...
		gl_panelIcodeSli.setHorizontalGroup(
			gl_panelIcodeSli.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panelIcodeSli.createSequentialGroup()
					.addContainerGap()
					.addGroup(gl_panelIcodeSli.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panelIcodeSli.createSequentialGroup()
							.addGroup(gl_panelIcodeSli.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panelIcodeSli.createSequentialGroup()
									.addComponent(lblAddrmode15693)
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(cmbAddrMode_iso15693, GroupLayout.PREFERRED_SIZE, 130, GroupLayout.PREFERRED_SIZE)
									.addGap(18)
									.addComponent(lblUid_iso15693)
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(cmbUid_iso15693, GroupLayout.PREFERRED_SIZE, 126, GroupLayout.PREFERRED_SIZE)
									.addGap(29)
									.addComponent(btnConnect_iso15693))
								.addGroup(gl_panelIcodeSli.createSequentialGroup()
									.addGroup(gl_panelIcodeSli.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_panelIcodeSli.createSequentialGroup()
											.addGap(70)
											.addComponent(textBlkData_iso15693, GroupLayout.PREFERRED_SIZE, 243, GroupLayout.PREFERRED_SIZE))
										.addComponent(lblBlkdata_iso15693))
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(lblBlkaddr_iso15693)
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(cmbBlkaddr_iso15693, GroupLayout.PREFERRED_SIZE, 54, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(lblBlknum_iso15693)))
							.addGap(1)
							.addGroup(gl_panelIcodeSli.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panelIcodeSli.createSequentialGroup()
									.addComponent(cmbBlkNum_iso15693, GroupLayout.PREFERRED_SIZE, 50, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(btnReadSigle_iso15693)
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(btnReadMul_iso15693)
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(btnWriteMutiple_iso15693)
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(btnGetsecState_iso15693, GroupLayout.DEFAULT_SIZE, 151, Short.MAX_VALUE))
								.addGroup(gl_panelIcodeSli.createSequentialGroup()
									.addComponent(btnDidconnect)
									.addPreferredGap(ComponentPlacement.UNRELATED)
									.addComponent(btnGetTagInfo_iso15693))))
						.addGroup(gl_panelIcodeSli.createSequentialGroup()
							.addComponent(lblAfi)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(textAfiVal, GroupLayout.PREFERRED_SIZE, 29, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(btnWriteAfi)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(lblDsfid)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(textDsfidVal, GroupLayout.PREFERRED_SIZE, 26, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(btnWriteDsfid)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(btnEnableEAS)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(btnDisableEAS)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(btnEAScheck)))
					.addContainerGap())
		);
		gl_panelIcodeSli.setVerticalGroup(
			gl_panelIcodeSli.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelIcodeSli.createSequentialGroup()
					.addGroup(gl_panelIcodeSli.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panelIcodeSli.createParallelGroup(Alignment.BASELINE)
							.addComponent(cmbAddrMode_iso15693, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
							.addComponent(lblUid_iso15693)
							.addComponent(cmbUid_iso15693, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
							.addComponent(btnConnect_iso15693)
							.addComponent(btnDidconnect)
							.addComponent(btnGetTagInfo_iso15693))
						.addComponent(lblAddrmode15693))
					...
					.addGroup(gl_panelIcodeSli.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panelIcodeSli.createParallelGroup(Alignment.BASELINE)
							.addComponent(textBlkData_iso15693, GroupLayout.PREFERRED_SIZE, 18, GroupLayout.PREFERRED_SIZE)
							.addComponent(lblBlkaddr_iso15693)
							.addComponent(cmbBlkaddr_iso15693, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
							.addComponent(lblBlknum_iso15693)
							.addComponent(cmbBlkNum_iso15693, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
							.addComponent(btnReadSigle_iso15693)
							.addComponent(btnReadMul_iso15693)
							.addComponent(btnWriteMutiple_iso15693)
							.addComponent(btnGetsecState_iso15693, GroupLayout.PREFERRED_SIZE, 23, GroupLayout.PREFERRED_SIZE))
						.addComponent(lblBlkdata_iso15693))
					.addGap(9)
					.addGroup(gl_panelIcodeSli.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblAfi)
						.addComponent(textAfiVal, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addComponent(btnWriteAfi, GroupLayout.PREFERRED_SIZE, 23, GroupLayout.PREFERRED_SIZE)
						.addComponent(lblDsfid)
						.addComponent(textDsfidVal, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addComponent(btnWriteDsfid)
						.addComponent(btnEnableEAS)
						.addComponent(btnDisableEAS)
						.addComponent(btnEAScheck))
		...
		btnConnect_iso15693.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				String sUid = cmbUid_iso15693.getItemAt(cmbUid_iso15693.getSelectedIndex());
				...
				if (addrMode!=0) {
					...
					m_uid = new byte[8];//无地址模式
				}
				int nret = rfidlib_AIP_ISO15693.ISO15693_Connect(m_hr, rfid_def.RFID_ISO15693_PICC_ICODE_SLI_ID, 
						addrMode,m_uid, ht);
				if (nret!=0) {
		...
		btnGetTagInfo_iso15693.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int nret = rfidlib_AIP_ISO15693.ISO15693_GetSystemInfo(m_hr, m_ht, uid, dsfid, afi, blkSize, numOfBloks, icRef);
				if (nret==0) {
					...
					/*String info = "uid:" + sUid + "\r\n" +
							...
							"IcRef:" + icRef;*/
					String info = String.format("uid:%s\r\nDSFID:%02X\r\nAFI:%02X\r\nBlock size:%d\r\nNum of block:%d\r\nIcRef:%02x", 
		...
		btnReadSigle_iso15693.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int nret =rfidlib_AIP_ISO15693.ISO15693_ReadSingleBlock(m_hr, m_ht, (byte) 0, blkAddr, bufBlockData, bufBlockData.length, bytesBlkDatRead);
				if (nret!=0) {
		...
		btnReadMul_iso15693.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int nret = rfidlib_AIP_ISO15693.ISO15693_ReadMultiBlocks(m_hr, m_ht, (byte) 0, blkAddr, numOfBlksToRead,
						numOfBlksRead,bufBlocks, bufBlocks.length, bytesBlkDatRead);
				if (nret!=0) {
					JOptionPane.showMessageDialog(null, "Read multi block failed!err="+nret);
					return;
				}
		...
		btnWriteMutiple_iso15693.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int nret = rfidlib_AIP_ISO15693.ISO15693_WriteMultipleBlocks(m_hr,m_ht,blkAddr,blkNum, newBlkData,4*blkNum);
				if (nret==0) {
					JOptionPane.showMessageDialog(null, "Write block OK");
				}
				else {
		...
		btnGetsecState_iso15693.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int ret = rfidlib_AIP_ISO15693.ISO15693_GetBlockSecStatus(m_hr, m_ht, blkAddr, numOfBlks, bufBlkSecs,
				...
				if (ret==0) {
					...
					JOptionPane.showMessageDialog(null, "Get block sestatus failed!err="+ret);
				}
		...
		btnWriteDsfid.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int nret = rfidlib_AIP_ISO15693.ISO15693_WriteDSFID(m_hr, m_ht, dsfid);
				if (nret==0) {
					JOptionPane.showMessageDialog(null, "Write DSFID ok!");
				}
				else {
					JOptionPane.showMessageDialog(null, "Write DSFID failed!err=" + nret);
				}
			}
		});
		btnWriteAfi.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int nret = rfidlib_AIP_ISO15693.ISO15693_WriteAFI(m_hr, m_ht, afi);
				if (nret==0) {
					JOptionPane.showMessageDialog(null, "Write AFI ok!");
				}
				else {
					JOptionPane.showMessageDialog(null, "Write AFI failed!err = "+nret);
				}
			}
		});
		btnEnableEAS.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int nret = rfidlib_AIP_ISO15693.NXPICODESLI_EableEAS(m_hr, m_ht);
				if (nret==0) {
					JOptionPane.showMessageDialog(null, "Enable EAS OK!");
				}
				else {
					JOptionPane.showMessageDialog(null, "Enable EAS failed!err="+nret);
				}
			}
		});
		btnDisableEAS.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int nret = rfidlib_AIP_ISO15693.NXPICODESLI_DisableEAS(m_hr, m_ht);
				if (nret==0) {
					JOptionPane.showMessageDialog(null, "Disable EAS OK!");
				}
				else {
					JOptionPane.showMessageDialog(null, "Disable EAS failed!err = " + nret);
				}		
			}
		});
		btnEAScheck.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int nret = rfidlib_AIP_ISO15693.NXPICODESLI_EASCheck(m_hr, m_ht, EASStatus);
				if (nret!=0) {
		...
		btnStartInventory.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (m_ht!=0) {
					JOptionPane.showMessageDialog(null, "Please disconnect the tag first!");
					return;
				}
//				Thread m_inventory = new Thread(MainFrm.this);
		...
		panelISO15693.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "ISO15693 inventory", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 70, 213)));
		GroupLayout gl_panelInventory = new GroupLayout(panelInventory);
		gl_panelInventory.setHorizontalGroup(
			gl_panelInventory.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelInventory.createSequentialGroup()
					.addContainerGap()
					.addComponent(tableInventory, GroupLayout.PREFERRED_SIZE, 405, GroupLayout.PREFERRED_SIZE)
					.addGap(18)
					.addGroup(gl_panelInventory.createParallelGroup(Alignment.LEADING, false)
						.addComponent(btnStopInventory, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(btnStartInventory, GroupLayout.DEFAULT_SIZE, 74, Short.MAX_VALUE))
					.addGap(32)
					.addComponent(panelISO15693, GroupLayout.PREFERRED_SIZE, 173, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addComponent(checkEnable14443A)
					.addContainerGap(21, Short.MAX_VALUE))
		);
		gl_panelInventory.setVerticalGroup(
			gl_panelInventory.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelInventory.createSequentialGroup()
					.addGroup(gl_panelInventory.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panelInventory.createSequentialGroup()
							.addContainerGap()
							.addGroup(gl_panelInventory.createParallelGroup(Alignment.BASELINE)
								.addComponent(tableInventory, GroupLayout.DEFAULT_SIZE, 107, Short.MAX_VALUE)
								.addGroup(gl_panelInventory.createSequentialGroup()
									.addComponent(btnStartInventory)
									.addGap(10)
									.addComponent(btnStopInventory))))
						.addComponent(panelISO15693, GroupLayout.PREFERRED_SIZE, 111, GroupLayout.PREFERRED_SIZE))
					.addGap(25))
				.addGroup(gl_panelInventory.createSequentialGroup()
					.addGap(18)
					.addComponent(checkEnable14443A)
		...
		gl_panelISO15693.setHorizontalGroup(
			gl_panelISO15693.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelISO15693.createSequentialGroup()
					.addContainerGap()
					.addGroup(gl_panelISO15693.createParallelGroup(Alignment.LEADING)
						.addComponent(checkOnlyNew)
						.addComponent(checkAfiMatch)
						.addGroup(gl_panelISO15693.createSequentialGroup()
							.addComponent(lblAFI)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(textAFI, 0, 0, Short.MAX_VALUE)))
					.addContainerGap(54, Short.MAX_VALUE))
		);
		gl_panelISO15693.setVerticalGroup(
			gl_panelISO15693.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelISO15693.createSequentialGroup()
					.addComponent(checkOnlyNew)
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addComponent(checkAfiMatch)
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addGroup(gl_panelISO15693.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblAFI)
						.addComponent(textAFI, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
					.addContainerGap())
		);
		...
		btnClose.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (m_ht!=0) {
					JOptionPane.showMessageDialog(null, "Please disconnect tag first!");
					return;
				}
		...
		btnGetRfidInfo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Integer nSize = new Integer(0);
				iret = rfidlib_reader.RDR_GetReaderInfor(m_hr,(byte) 0,buffer,nSize);
				...
				textIP.setText("192.168.5.7");
				textIP.setColumns(10);
		
				JLabel lblPort = new JLabel("Port:");
		
				textPort.setText("6012");
			...
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						.addComponent(cmbComName, GroupLayout.PREFERRED_SIZE, 113, GroupLayout.PREFERRED_SIZE)
						.addComponent(cmbDevType, GroupLayout.PREFERRED_SIZE, 99, GroupLayout.PREFERRED_SIZE))
					.addGap(18)
					.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
					...
					.addPreferredGap(ComponentPlacement.RELATED)
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						.addComponent(cmbCommType, GroupLayout.PREFERRED_SIZE, 96, GroupLayout.PREFERRED_SIZE)
						.addComponent(textIP, GroupLayout.PREFERRED_SIZE, 100, GroupLayout.PREFERRED_SIZE))
					.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
						.addGroup(Alignment.LEADING, gl_panel.createSequentialGroup()
							...
							.addGap(18)
							.addComponent(btnGetRfidInfo))
						.addGroup(Alignment.LEADING, gl_panel.createSequentialGroup()
							.addGap(31)
							.addComponent(lblPort)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(textPort, GroupLayout.PREFERRED_SIZE, 39, GroupLayout.PREFERRED_SIZE)))
					.addGap(344))
		);
			...
			gl_panel.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel.createSequentialGroup()
							...
							.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
								.addComponent(lblReaderType)
								.addComponent(cmbDevType, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
						.addGroup(gl_panel.createSequentialGroup()
							.addGap(3)
							.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
								.addComponent(lblCommType)
								.addComponent(cmbCommType, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
								.addComponent(btnOpen)
								.addComponent(btnClose)
								.addComponent(btnGetRfidInfo))))
					.addGap(18)
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
							.addComponent(cmbComName, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
							.addComponent(lblComName)))
					.addGap(21))
		);
	...
	private void OpenDev(){
		String connstr = null;
		String sDevName = cmbDevType.getItemAt(cmbDevType.getSelectedIndex()).toString();
		int idx = cmbCommType.getSelectedIndex();
		System.out.println("OpenDev :" + idx +" > " +sDevName);
		switch (idx) {
		case 0:
			...
			connstr = rfid_def.CONNSTR_NAME_RDTYPE +"="+ sDevName + ";"+
					rfid_def.CONNSTR_NAME_COMMTYPE + "=" + rfid_def.CONNSTR_NAME_COMMTYPE_COM + ";" +
		...
		case 2:
			connstr = rfid_def.CONNSTR_NAME_RDTYPE + "=" + sDevName + ";" +
					rfid_def.CONNSTR_NAME_COMMTYPE + "=" + rfid_def.CONNSTR_NAME_COMMTYPE_NET + ";" +
					rfid_def.CONNSTR_NAME_REMOTEIP + "=" + textIP.getText() + ";" +
					rfid_def.CONNSTR_NAME_REMOTEPORT + "=" + textPort.getText() + ";" +
	...
	public static void main(String []args){
		new MainFrm();
//		new MainFrm().LoadDriver();
//		new MainFrm().OpenDev();
//		new MainFrm().readRFID();
	}
	...
	public void readRFID() {
		...
		while(b_inventoryFlg){
			...
			System.out.println("m_hr :" + m_hr +" AntennaIDs : " + AntennaIDs +"InvenParamSpecList :" + InvenParamSpecList);
			if (nret!=0) {
				continue;
			}
			...
			while (dnhReport!=0) {
				...
				if (b_iso15693) {
					...
					if (nret==0) {
						String sUid = gFunction.encodeHexStr(uid);
						System.out.println("b_iso15693: " + sUid);
				...
				if (b_iso14443a) {
					...
					if(nret == 0){
						...
						System.out.println("b_iso14443a: " + sUid);
						AddTagToTable(aip_id,tag_id, sUid);
					}
				}
	...
	private void AddTagToTable(int aip_id,int tag_id,String sUid){
		...
		if(aip_id==rfid_def.RFID_APL_ISO15693_ID){
			...
			if(tag_id==rfid_def.RFID_ISO14443A_PICC_NXP_MIFARE_S50_ID||tag_id==rfid_def.RFID_ISO14443A_PICC_NXP_MIFARE_S70_ID)
			{
